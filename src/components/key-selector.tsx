    ...
    <label className="flex items-center gap-2 text-sm">
      ...
      <span className="relative">
        <select
          ...
          className="w-24 appearance-none rounded-md border border-zinc-300 bg-white py-1.5 pl-3 pr-8 font-medium text-zinc-900 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100"
        >
          {KEY_ORDER.map((k) => (
